...
bd_manipulator = MySQLManipulator(host='localhost', user='root', password='root', database='energy_monitor',port=3306)
...
def handle_message(client, userdata, msg):
        ...
        #insert_data
        bd_manipulator.insert_data(mensagem, topico, qos, data_hora_medicao,tabela ='sensor')
